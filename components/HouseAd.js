      ...
      >
        {ad.media && !artFailed ? (
          <Image
            ...
            style={styles.art}
            resizeMode="cover"
            // A bundled asset failing is close to impossible, but if it does the parent swaps
            // this slot for the live-facts card rather than showing a broken frame.
...
const makeStyles = (c) => StyleSheet.create({
  ...
  // Space Mono eyebrow — structural label, per DESIGN.md's Mono Is Structural rule. It is doing
  // real work here: it tells the traveller this is a sibling app, not a sponsor.
  eyebrow: {
