...
List up to 8 specific, hunt-able interests this person would light up about — niche and concrete (e.g. "pinball", "arcades", "record stores", "live music", "surf", "tides", "sunset"), not generic ("food"). Rank by how strongly the signals point to each.
