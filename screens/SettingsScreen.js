...
export default function SettingsScreen() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setBudget(s.budget);
      setGroup(s.group);
      setGettingAround(s.gettingAround ?? DEFAULT_GETTING_AROUND);
  ...
  const handleGettingAround = (v) => { setGettingAround(v); save(KEYS.GETTING_AROUND, v); };
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        ...
        >
          ...
          <CollapsibleCard title="ITINERARY PREFERENCES" sectionKey="preferences" summary={prefsSummary} style={styles.collapsibleSpacing}>
            ...
            {/* Unlike the rest of this block, this one constrains what gets PLANNED, not just
                how it's scored — a walking default genuinely narrows where stops can be. */}
            <Text style={[styles.fieldLabel, { marginTop: 14 }]}>GETTING AROUND</Text>
            <PillRow options={GETTING_AROUND_OPTIONS} selected={gettingAround} onSelect={handleGettingAround} />
