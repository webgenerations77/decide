...
export function validateStops(raw) {
  ...
  return arr.filter((s) =>
    ...
    ...(s.verified === true ? {} : s.time_note ? { time_note: String(s.time_note) } : {}),
    ...(s.verified === true ? {} : typeof s.unverified === 'boolean' ? { unverified: s.unverified } : {}),
    ...(s.verified === true ? { verified: true } : {}),
    ...(s.verified === true && s.verify_source ? { verify_source: String(s.verify_source) } : {}),
